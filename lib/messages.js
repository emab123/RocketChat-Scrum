...
exports.getMessage = function(id, data) {
    switch(id) {
        ...
        case messageList.OBSTACLES:
            return `Gibt es Ergebnisse oder Input, die du brauchst um weitermachen zu können?`;
        ...
        case messageList.LATE_SUMMARY:
            return `Hey @here, @${data.user.username} hat noch einen Stand-Up nachgeliefert👌🐱‍👓\r\n`;
